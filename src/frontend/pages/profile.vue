<template>
  <div class="min-h-screen bg-gradient-to-b from-white to-[#FFE5AE]/20 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <!-- Header -->
      <div class="mb-8">
        <h1 class="text-4xl font-bold text-text-primary">Profile Settings</h1>
        <p class="mt-2 text-text-secondary">Manage your account and preferences</p>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <div class="flex items-center">
                  <div class="relative">
                    ...
                    >
                      <div class="w-4 h-4 i-heroicons-pencil text-white"></div>
                    </button>
                    <input
                      type="file"
                      ref="fileInput"
        ...
        <div class="lg:col-span-1 space-y-8">
          ...
          <div class="bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-lg">
            <h2 class="text-lg font-medium text-text-primary mb-4">Account Overview</h2>
            <div class="space-y-4">
          ...
          <!-- Account Actions -->
          <div class="bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-lg">
            <h2 class="text-lg font-medium text-text-primary mb-4">Account Actions</h2>
            <div class="space-y-3">
              <button
              ...
              >
                ...
                <div class="w-5 h-5 i-heroicons-key"></div>
              </button>
              <button
                class="w-full flex items-center justify-between px-4 py-2 text-text-primary hover:bg-gray-50 rounded-lg transition-colors"
              ...
              >
                ...
                <div class="w-5 h-5 i-heroicons-arrow-down-tray"></div>
              </button>
              <button
              ...
              >
                ...
                <div class="w-5 h-5 i-heroicons-trash"></div>
              </button>
            </div>
          </div>
        </div>
