  ...
  <div class="container mx-auto py-10 px-4">
    ...
    >
      <div class="flex flex-col items-center justify-center">
        ...
        <h2 class="text-xl font-medium">Loading Credential...</h2>
      </div>
    </div>
    ...
    >
      <div class="text-center">
        ...
        >
          <div class="i-lucide-search mr-2"></div>
    ...
    >
      <div class="text-center">
        ...
        <button 
          ...
          class="inline-flex items-center px-4 py-2 rounded-lg bg-primary-500 hover:bg-primary-600 text-white transition-colors"
        >
          <div class="i-lucide-refresh-cw mr-2"></div>
          Try Again
        </button>
      </div>
    </div>
    ...
    <div v-else-if="credential" class="max-w-4xl mx-auto">
      ...
      >
        ...
        <div v-if="verificationResult?.checks?.length" class="mt-6">
          <h4 class="font-medium mb-3">Verification Checks</h4>
          <div class="space-y-2">
            <div 
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div v-if="credential.issuer" class="space-y-2">
              ...
              <div class="flex items-center">
                ...
                />
                <div>
                  <div class="font-medium">{{ credential.issuer.name }}</div>
                  <a 
      ...
      >
        ...
        <div class="prose max-w-none">
          ...
          <div v-if="credential.credentialSubject.achievement.criteria?.narrative" class="mt-6">
            <h4 class="font-medium mb-2">Criteria</h4>
          ...
          <div 
            ...
            class="mt-6"
          >
            <h4 class="font-medium mb-2">Alignments</h4>
            <div class="space-y-4">
              <div 
