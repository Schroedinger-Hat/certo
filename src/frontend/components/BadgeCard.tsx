...
export const BadgeCard: React.FC<BadgeCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        <h3 className="text-lg font-semibold line-clamp-1">{badge.attributes.name}</h3>
        <p className="mt-1 text-sm text-gray-500 line-clamp-2">{badge.attributes.description}</p>
